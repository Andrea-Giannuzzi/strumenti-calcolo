...
| File | Scopo |
| --- | --- |
| [`symbolic_derivatives.py`](Strumenti%20Calcolo/symbolic_derivatives.py) | Esempi guidati di derivate simboliche, derivate parziali, funzioni composte e termini dell'equazione di Eulero-Lagrange. |
