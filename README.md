...
`Strumenti Calcolo` is a collection of small Python scripts for symbolic
computation and for supporting physics and mathematics exercises.

The project starts with a script for symbolic derivatives, but it is designed
...
| File | Purpose |
| --- | --- |
| [`symbolic_derivatives.py`](Strumenti%20Calcolo/symbolic_derivatives.py) | Guided examples of symbolic derivatives, partial derivatives, composite functions, and terms in the Euler-Lagrange equation. |
...
- [`README_symbolic_derivatives.md`](Strumenti%20Calcolo/README_symbolic_derivatives.md)
